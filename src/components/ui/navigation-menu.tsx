...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn('flex flex-1 mt-4', className)}
    {...props}
  >
    {children}
...
>(({ className, changeColor = false, ...props }, ref) => (
  <NavigationMenuPrimitive.Item
    ref={ref}
    className={cn(
      `cursor-pointer ${changeColor ? 'text-yellow hover:text-yellow' : 'text-white hover:text-opacity-100 text-opacity-75'}`,
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] w-2 rotate-45 rounded-tl-sm bg-slate-200 shadow-md dark:bg-slate-800" />
  </NavigationMenuPrimitive.Indicator>
))
